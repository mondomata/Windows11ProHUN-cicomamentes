...
🛠️🛠️🛠️💕Másik módszer (haladóknak):
   Powershell parancsorban (jobb klikk a Start ikonon, majd Powershell, vagy Terminál választás a felugró listán) indítsd el ezt (kód bemásolása és <tt>Enter</tt> a Powershell-ben):
